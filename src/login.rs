...
use actix_web::{HttpRequest, get, post, delete, web, HttpResponse};
...
/// Actual Oauth2 impl
async fn login_user(data: &models::AppState, code: String, redirect_url: String) -> Result<models::OauthUserLogin, models::OauthError> { 
